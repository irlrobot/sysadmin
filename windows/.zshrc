...
plugins=(rails git ruby rvm aws cap gem git-extras history github jsontools sudo wd)
...
alias gh='cd /mnt/c/Users/joshcb/repos'
alias gb='git branch'
...
alias mkvenv3='virtualenv -p /usr/bin/python3 venv'
alias mkvenv2='virtualenv -p /usr/bin/python venv'
